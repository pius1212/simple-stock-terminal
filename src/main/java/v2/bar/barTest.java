...
import v1.stock.algo.wld.wldAlgo;
import v1.stock.alpaca.alpacaIndicatorData;
import v1.stock.alpaca.alpacaPositions;
import v1.stock.global.colors;
import v1.stock.handler.changeTicker;
import v1.stock.polygon.polygonListener;
import v1.stock.polygon.polygonTickerDetailed;
...
import static v1.stock.algo.custom.shortcuts.dtf;
import static v1.stock.algo.custom.shortcuts.wld;

public class barTest {
    public static List <bar> bars = new CopyOnWriteArrayList <bar> ();
    public static v2.bar.liveBar liveBar = new liveBar(0, 0, 0, 0, false);
    ...
    public static void wldTest(JImGui imGui){
        ...
        imGui.plotLines("WLD v1.test", dtf(x), 0, x.length, "WLD v1.test",380, 180);
