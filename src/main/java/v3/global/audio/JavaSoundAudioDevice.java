...
public class JavaSoundAudioDevice extends AudioDeviceBase {
    ...
    public JavaSoundAudioDevice(FileInputStream fileInputStream) {
...
//                }
    ...
    /**
     * Runs a short v1.test by playing a short silent sound.
     */
    public void test()
            throws JavaLayerException {
//        try {
...
//            throw new JavaLayerException("Device v1.test failed: " + ex);
//        }
