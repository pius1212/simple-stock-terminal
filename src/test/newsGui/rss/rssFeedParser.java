...
public class rssFeedParser {
	...
	public feed readFeed() {
		...
		try {
			...
			String htmlTagFilters = stylingFilter.replace("&lt;/li&gt;", "").replace("&lt;li&gt;", "").replace("&lt;/ul&gt;", "").replace("&lt;ul&gt;", "").replace("&lt;/h3&gt;", "").replace("&lt;h3&gt;", "").replace("&lt;u&gt;", "").replace("&lt;/u&gt;", "").replace("&lt;a", "").replace("&lt;/a&gt;", "").replace("&lt;br /&gt;", "").replace("&lt;em&gt;", "").replace("&lt;/em&gt;", "").replace("&lt;/strong&gt;", "").replace("&lt;strong&gt;", "").replace("&lt;/p&gt;", "").replace("&lt;p&gt;", "").replace(" p ", " ");
			...
			String tagSymbolFilters = linkFilters.replace("&lt;", "").replace("&gt;", "").replace("nbsp;", "");
			String miscFilters = tagSymbolFilters.replace(" (NYSE:  class=\"ticker\"", "");
			InputStream stream = new ByteArrayInputStream(miscFilters.getBytes(StandardCharsets.UTF_8));
			System.out.println(miscFilters);
